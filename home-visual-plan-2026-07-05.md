...
- 2026-07-05 「标题换行」定位结果：非浏览器 bug，是卡片头部设计为
  ...
  「图标 + 标题」同行的 flex 头部布局。
- 2026-07-05 修复 hero 与 LiveStats 生硬接壤：hero 底部原本被
  overflow-hidden 硬切 aurora/网格形成分界线，卡片又只 -mt-2 贴线。
  改为 hero 底部 14rem 渐隐到页面底色 + 卡片 -mt-12/-mt-16 悬浮跨界，
  卡片底色加深为 #070d1b/80 + backdrop-blur-md 以免透出过渡区。
- 2026-07-05 按反馈回退点阵密度（2.5°×1.8° → 原 3.6°×2.6°），改为
  扩充城市光点：12 → 22 个（新增莫斯科、华沙、阿拉木图、迪拜、开罗、
  拉各斯、约翰内斯堡、多伦多、墨西哥城、首尔），覆盖东欧/俄罗斯/
  中亚/非洲/加拿大/拉美。
