...
Pushy (npm 包名: [`react-native-update`](https://www.npmjs.com/package/react-native-update) [![npm version](https://badge.fury.io/js/react-native-update.svg)](http://badge.fury.io/js/react-native-update)) 是面向 React Native 应用提供的**专业热更新服务**，由 [React Native 中文网](https://reactnative.cn)独家研发并持续维护。我们致力于为中国开发者提供最快速、最稳定、最经济的热更新体验。
