...
规则说明：仅整单年付赠送，月付、升级补差价、加购更新查询额度、试用均不赠送。额度充入后永久有效，仅限平台内使用，不可提现或转让；订单退款时扣回已使用部分。大客户方案请与商务另行约定。
